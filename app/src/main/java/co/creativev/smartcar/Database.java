...
public class Database extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("create table inputs(_id integer primary key autoincrement, request_id integer not null, input text, record_time datetime default CURRENT_TIMESTAMP)");
        db.execSQL("create table outputs(_id integer primary key autoincrement, request_id integer not null, input text, record_time datetime default CURRENT_TIMESTAMP)");
    }
